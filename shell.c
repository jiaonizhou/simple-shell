...
/*
    printf("%s\n", cmds[0].cmd);
    if (cmds[0].cmd != NULL) printf("%lu\n", strlen(cmds[0].cmd));
    printf("%s\n", cmds[0].infile);
    if (cmds[0].infile != NULL) printf("%lu\n", strlen(cmds[0].infile));
    printf("%s\n", cmds[0].outfile);
    if (cmds[0].outfile != NULL) printf("%lu\n", strlen(cmds[0].outfile));
    printf("%s\n", cmds[1].cmd);
    if (cmds[1].cmd != NULL) printf("%lu\n", strlen(cmds[1].cmd));
    printf("%s\n", cmds[1].infile);
    if (cmds[1].infile != NULL) printf("%lu\n", strlen(cmds[1].infile));
    printf("%s\n", cmds[1].outfile);
    if (cmds[1].outfile != NULL) printf("%lu\n", strlen(cmds[1].outfile));
    printf("%d\n", num_of_commands);
*/
